...
import {
  RLEDecipher,
  RLEEncipher,
} from "../components/JxgContainer/gameOfLife/RLE";
...
24bo$22bobo$12b2o6b2o12b2o$11bo3bo4b2o12b2o$2o8bo5bo3b2o$2o8bo3bob2o4bobo$10bo5bo7bo$11bo3bo$12b2o!`;
  const patternInfo: RLEDecipherResult = {
    ...
    result: JSON.parse(
      "[[10,26],[11,24],[11,26],[12,14],[12,15],[12,22],[12,23],[12,36],[12,37],[13,13],[13,17],[13,22],[13,23],[13,36],[13,37],[14,2],[14,3],[14,12],[14,18],[14,22],[14,23],[15,2],[15,3],[15,12],[15,16],[15,18],[15,19],[15,24],[15,26],[16,12],[16,18],[16,26],[17,13],[17,17],[18,14],[18,15]]"
    ) as CoordinatedPattern,
  };
  const rawRLEtext = RLEEncipher(patternInfo);

  expect(rawRLEtext).toEqual(gosperglidergun);
});
...
bo$obo$o2bo$b2o13$14b3o$14bo$15bo!`;
  ...
  console.log("loafpull");
  const rawRLEtext = RLEEncipher(patternInfo);

  expect(rawRLEtext).toEqual(loafpull);
});
...
3bobo$bo2bo2bo$obobobobo$o3bo3bo$b2obob2o$4bo!`;
  ...
  expect(rawRLEtext).toEqual(_2_2_4);
});
...
3bo$2bobo$bob2o$obo2b2o$b2o2bobo$3b2obo$3bobo$4bo!`;
  ...
  expect(rawRLEtext).toEqual(boats);
});
...
2bo$3bo$bo2bo$3o$bo!`;
  ...
  expect(rawRLEtext).toEqual(yeast);
});

/* Test integration of RLEEncipher and RLEDecipher */

test("Test RLE Integration Case 1: Gosper glider gun", () => {
  const gosperglidergun = `#N Gosper glider gun
#O Bill Gosper
#C A true period 30 glider gun.
#C The first known gun and the first known finite pattern with unbounded growth.
...
24bo11b$22bobo11b$12b2o6b2o12b2o$11bo3bo4b2o12b2o$2o8bo5bo3b2o14b$2o8b
o3bob2o4bobo11b$10bo5bo7bo11b$11bo3bo20b$12b2o!`;
  const rawPatternText = RLEEncipher(RLEDecipher(gosperglidergun));
  const { width, height, result } = RLEDecipher(rawPatternText);
...
test("Test RLE Integration Case 2: loafpull", () => {
  const loadpull = `#N loafpull.rle
#C https://conwaylife.com/wiki/Loaf_pull
#C https://www.conwaylife.com/patterns/loafpull.rle
x = 17, y = 19, rule = B3/S23
bo$obo$o2bo$b2o13$14b3o$14bo$15bo!`;
  const rawPatternText = RLEEncipher(RLEDecipher(loadpull));
  const { width, height, result } = RLEDecipher(rawPatternText);
...
test("Test RLE Integration Case 3: 2.2.4", () => {
  const _2_2_4 = `#N 2.2.4.rle
#C https://conwaylife.com/wiki/2.2.4
#C https://www.conwaylife.com/patterns/2.2.4.rle
x = 9, y = 6, rule = B3/S23
3bobo$bo2bo2bo$obobobobo$o3bo3bo$b2obob2o$4bo!`;
  ...
  const rawPatternText = RLEEncipher(RLEDecipher(_2_2_4));
  const { width, height, result } = RLEDecipher(rawPatternText);
...
test("Test RLE Integration Case 4： boats", () => {
  const boats = `#N 4 boats
#C A period 2 oscillator made up of 4 boats.
x = 8, y = 8, rule = B3/S23
3bo4b$2bobo3b$bob2o3b$obo2b2ob$b2o2bobo$3b2obob$3bobo2b$4bo!`;

  const rawPatternText = RLEEncipher(RLEDecipher(boats));
  const { width, height, result } = RLEDecipher(rawPatternText);
...
test("Test RLE Integration Case 5: yeast", () => {
  const yeast = `#N yeast.rle
#C https://conwaylife.com/wiki/Bakery
#C https://www.conwaylife.com/patterns/yeast.rle
x = 5, y = 5, rule = B3/S23
2bo$3bo$bo2bo$3o$bo!`;
  ...
  const rawPatternText = RLEEncipher(RLEDecipher(yeast));
  const { width, height, result } = RLEDecipher(rawPatternText);
